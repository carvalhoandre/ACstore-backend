...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.andrecarvalho.projeto.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do AC Store", "Esta API é utilizada no curso de Spring Boot do prof. Nelio Alves",
				"Versão 1.0", "https://www.udemy.com/terms",
				new Contact("André Leite Carvalho", "https://github.com/carvalhoandre", "''.carvalho.devel@gmail.com"),
				"Permitido para leitura.", "https://www.udemy.com/terms", Collections.emptyList() // Vendor
		// Extensions
		);
	}
